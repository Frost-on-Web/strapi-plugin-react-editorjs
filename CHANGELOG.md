...
- Set up the "settings" page + store those with the conventionnal Strapi API
- Making this work (for Strapi 4.1X)

## [3.0.0](https://github.com/xenobytezero/strapi-plugin-react-editorjs/tree/4.10_update) (2023-07-08)

- Updated code from @xenobytezero
